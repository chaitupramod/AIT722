...
three_points_extracted.txt - It is a text file containing the X, Y and Z co-ordinates. This file will be used in the build_features.py file to find the three closest points, given a point.
